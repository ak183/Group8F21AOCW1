...
const record=require('../../model/patient-record_schema')
const {checkdoctor}=require('../../middleware/User_check')
const mongoose=require('mongoose')
const validation=require('../../validation/treatment_validation')
